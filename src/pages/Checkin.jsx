      ...
      <div className="stage-container">
          ...
          <div className="header-content">
            <div className="header-left">
              ...
              <div className="page-info">
                <h1 className="page-title">Check in participants</h1>
              </div>
            </div>
          </div>
        </header>
        ...
        <main className="stage-main">
          <div className="stage-cards">
            <div
              className="stage-card primary"
              onClick={() => navigate("/arrival/scan")}
            >
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Scan student QR codes to checkin users
                </p>
              </div>
            ...
            <div className="stage-card secondary">
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Access user checkin records and history
                </p>
